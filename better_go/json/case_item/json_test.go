...
const itemJson = `{"impTime":1653923567,"cTime":1653923567,"iid":"qoIEL","fps":["v_FAb5m","muM84","qoIEK","qhoDV","i_U3YNb"]}`
...
func init() {
	...
	_ = json.Unmarshal([]byte(itemJson), &xxx)
}

// func Benchmark__Unmarshal_ori(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		Unmarshal_ori(u)
// 	}
// }

// func Benchmark__Unmarshal_jsoniterator(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		Unmarshal_jsoniterator(u)
// 	}
// }

// func Benchmark__Unmarshal_easyjson(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		Unmarshal_easyjson(u)
// 	}
// }

// func Benchmark__Unmarshal_sonic(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		Unmarshal_sonic(u)
// 	}
// }

func Benchmark__Marshal_ori(b *testing.B) {
	for i := 0; i < b.N; i++ {
		Marshal_ori(m)
	}
}

func Benchmark__Marshal_jsoniterator(b *testing.B) {
	for i := 0; i < b.N; i++ {
		Marshal_jsoniterator(m)
	}
}

func Benchmark__Marshal_easyjson(b *testing.B) {
	for i := 0; i < b.N; i++ {
		Marshal_easyjson(m)
	}
}

func Benchmark__Marshal_sonic(b *testing.B) {
	for i := 0; i < b.N; i++ {
		Marshal_sonic(m)
	}
}

func Benchmark__Marshal_std_2(b *testing.B) {
	for i := 0; i < b.N; i++ {
		json.Marshal(_BindingValue)
	}
}

func Benchmark__Marshal_sonic_2(b *testing.B) {
	for i := 0; i < b.N; i++ {
		sonic.Marshal(_BindingValue)
	}
}

func Benchmark__Marshal_jsoniterator_2(b *testing.B) {
	for i := 0; i < b.N; i++ {
		json2.Marshal(_BindingValue)
	}
}

// func Benchmark__Unmarshal_std_2(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		var x TwitterStruct
// 		json.Unmarshal([]byte(TwitterJson), &x)
// 	}
// }
//
// func Benchmark__Unmarshal_sonic_2(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		var x TwitterStruct
// 		sonic.Unmarshal([]byte(TwitterJson), &x)
// 	}
// }

// func Benchmark__Encode_sonic_2(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		encoder.Encode(_BindingValue, 0)
// 	}
// }
